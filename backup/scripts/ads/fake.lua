...
public.showBanner = function( provider, id, position, placement, height )
   ...
   lastBanner.tray = display.newRect( lastBanner, display.contentCenterX, 0, display.actualContentWidth, height )
      ...
      if( event.numTaps >= 2 ) then
         ...
         timer.performWithDelay( hideDelay,
            function()
               ...
               helpers.easyAlert( "Select Rewarded Reponse", "Which rewardeded video response do you want to simulate?",
